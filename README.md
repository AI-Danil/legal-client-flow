...
- панель выбранного клиента со следующим шагом и историей действий;
- индикатор ожидания для новых заявок с подсветкой просрочки SLA (15 минут);
- предупреждение о дубле при добавлении клиента с уже существующим телефоном;
